...
export const OrchestratorState = Annotation.Root({
  ...
  // ============================================================
  // DESIGN PHASE STATE CHANNELS
  // ============================================================

  // Current design phase: stylesheet first, then screens
  designPhase: Annotation<DesignPhase>({
    reducer: lastValue,
    default: () => 'research' as DesignPhase,
  }),

  // Whether stylesheet has been approved (gate before screen generation)
  stylesheetApproved: Annotation<boolean>({
    reducer: lastValue,
    default: () => false,
  }),

  // Whether all screens have been approved (gate before PM)
  screensApproved: Annotation<boolean>({
    reducer: lastValue,
    default: () => false,
  }),

  // Screen mockups generated after stylesheet approval
  screenMockups: Annotation<ScreenMockup[]>({
    reducer: appendReducer,
    default: () => [],
  }),
});
...
/**
 * Screen mockup generated by UI Designer
 */
